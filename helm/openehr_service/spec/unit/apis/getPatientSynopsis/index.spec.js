...
describe('apis/getPatientSynopsis', () => {
  let args;
  let finished;
  ...
  beforeEach(() => {
    ...
    mockery.registerMock('../../lib/commands', { GetPatientSynopsisCommand });

    delete require.cache[require.resolve('@apis/getPatientSynopsis')];
    handler = require('@apis/getPatientSynopsis');
  });
