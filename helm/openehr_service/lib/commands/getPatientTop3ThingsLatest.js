...
const debug = require('debug')('helm:openehr:commands:get-patient-top3things-latest');

class GetPatientTop3ThingsLatestCommand {
...
module.exports = GetPatientTop3ThingsLatestCommand;
